...
public class VistaInicioSesion extends javax.swing.JInternalFrame {
    ...
    private void btIniciarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btIniciarActionPerformed
        ...
        if (us!=null) {
                ValidarSesion vlSesion = ValidarSesion.getValidarSesion(us.getPersonaId(),us.getIdUs(),us.getRol());  
                vlSesion.setId(us.getPersonaId());
                vlSesion.setCurso(us.getIdUs());
                vlSesion.setRol(us.getRol());
